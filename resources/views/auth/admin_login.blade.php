...
<head>
  <meta charset="utf-8">
    ...
    <title>EasyTech Admin - Log in </title>
            		...
            		@csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name="email" :value="old('email')" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="E-mail">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								  ...
								  <div class="row">
									<div class="col-6">
									  <div class="checkbox text-white">
										...
										<label for="basic_checkbox_1" id="remember_me" name="remember">Remember Me</label>
									  </div>
									</div>
									<!-- /.col -->
									<div class="col-6">
